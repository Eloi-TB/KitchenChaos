...
public class CuttingCounter : BaseCounter, IHasProgress
{
    ...
    [SerializeField] private CuttingRecipeSO[] cuttingRecipieSOArray;
        ...
        if (!HasKitchenObject())
        {
            ...
            if (player.HasKitchenObject())
            {
                if (HasRecipeWithInput(player.GetKitchenObject().GetKitchenObjectSO()))
                {
                    ...
                    CuttingRecipeSO cuttingRecipieSO = GetCuttingRecipeSOWithInput(GetKitchenObject().GetKitchenObjectSO());
    ...
    {
        CuttingRecipeSO cuttingRecipieSO = GetCuttingRecipeSOWithInput(inputKitchenObjectSO);
    ...
    {
        foreach (CuttingRecipeSO cuttingRecipieSO in cuttingRecipieSOArray)
        {
